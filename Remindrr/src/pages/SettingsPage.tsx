...
import { BackIcon, SaveIcon } from '../components/settings/Icons';
import { StripeGuide } from '../components/settings/StripeGuide';
import { StatusBadge } from '../components/settings/StatusBadge';

// ─── Stripe Setup Guide ───────────────────────────────────────────────────────
// (moved to ../components/settings/StripeGuide.tsx)
// ─── Email Setup Guide ────────────────────────────────────────────────────
// (moved to ../components/settings/EmailGuide.tsx)
// ─── Connection Status Badge ──────────────────────────────────────────────────
// (moved to ../components/settings/StatusBadge.tsx)
// ─── Gmail OAuth ─────────────────────────────────────────────────────────────
// (moved to ../components/settings/GmailSection.tsx)
